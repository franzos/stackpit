...
projects-repos-forge-override = ชนิดฟอร์จ
projects-repos-forge-detected = ตรวจพบอัตโนมัติ
projects-repos-forge-override-help = ตั้งค่านี้เฉพาะเมื่อชนิดที่ตรวจพบไม่ถูกต้อง โดยทั่วไปคืออินสแตนซ์ที่โฮสต์เองซึ่งชื่อโฮสต์ไม่บอกว่าใช้ฟอร์จใด
projects-repos-prefix = คำนำหน้าเส้นทางในสแตก
projects-repos-prefix-placeholder = services/api/
projects-repos-prefix-help = ระบุว่าเฟรมสแตกใดเป็นของที่เก็บโค้ดนี้ โดยเทียบกับส่วนต้นของชื่อไฟล์ในเฟรม เว้นว่างไว้สำหรับโปรเจกต์ที่มีที่เก็บโค้ดเดียว เมื่อที่เก็บโค้ดใดที่นี่มีคำนำหน้าแล้ว จะใช้การจับคู่ด้วยคำนำหน้าเท่านั้น และที่เก็บโค้ดที่ไม่มีคำนำหน้าจะไม่สร้างลิงก์ซอร์สอีกต่อไป
projects-repos-col-prefix = คำนำหน้าเส้นทาง
projects-integrations-reset = คืนค่าเริ่มต้นขององค์กร
projects-integrations-reset-confirm = ทิ้งการตั้งค่าของโปรเจกต์นี้และกลับไปส่งตามค่าเริ่มต้นขององค์กรหรือไม่
projects-integrations-global-hint = การเชื่อมต่อนี้ส่งไปยังทุกโปรเจกต์ในองค์กร การตั้งค่าด้านล่างปรับแต่งเฉพาะที่นี่ หากต้องการหยุดส่งทั้งหมด ให้ยกเว้นโปรเจกต์นี้ในหน้าของการเชื่อมต่อ
projects-integrations-tracker-hint = ที่เก็บโค้ดปลายทางมาจากการตั้งค่าที่เก็บโค้ดของโปรเจกต์นี้ ไม่ใช่จากที่นี่
projects-repos-inert = ไม่ทราบฟอร์จ
projects-repos-inert-help = Stackpit ระบุไม่ได้ว่าโฮสต์นี้ใช้ฟอร์จใด ที่เก็บโค้ดจึงไม่สร้างลิงก์ไปยังซอร์ส และไม่จับคู่กับตัวติดตามปัญหาใด เลือกฟอร์จด้านล่างแล้วบันทึก
projects-integrations-activate-tracker-heading = เปิดใช้งานตัวติดตามปัญหา
projects-integrations-activate-tracker-help = ให้โปรเจกต์นี้เปิดปัญหาได้เมื่อต้องการ ที่เก็บโค้ดปลายทางมาจากที่เก็บโค้ดของโปรเจกต์ จึงไม่มีอะไรต้องตั้งค่าเพิ่มที่นี่
