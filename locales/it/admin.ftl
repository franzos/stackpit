# Superficie admin: la pagina dei progetti non assegnati
# (templates/admin_unassigned.html). Usa nav-project per l'intestazione della
# colonna "Progetto". Questa pagina ha uno snapshot test byte-identico; solo i
# valori inglesi devono corrispondere. I separatori (›, -) restano nel template.
admin-unassigned-title = Progetti non assegnati - Stackpit
admin-breadcrumb-admin = Admin
admin-unassigned-heading = Progetti non assegnati
admin-unassigned-subtitle = Progetti registrati automaticamente senza un'organizzazione. Riassegnali a un'organizzazione reale.
admin-unassigned-empty = Nessun progetto non assegnato. Tutti i progetti appartengono a un'organizzazione reale.
admin-col-source = Origine
admin-col-assign = Assegna a organizzazione
admin-id-prefix = id:
