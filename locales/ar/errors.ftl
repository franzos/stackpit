...
flash-license-empty = الصق مفتاح الترخيص للتفعيل.
flash-license-bad-signature = هذا الترخيص غير صالح لهذا التثبيت. تأكّد من لصق المفتاح الصحيح.
flash-license-wrong-product = هذا الترخيص ليس لـ Stackpit.
flash-license-unreadable = تعذّرت قراءة هذا الترخيص. راجعه وحاول مرة أخرى.
