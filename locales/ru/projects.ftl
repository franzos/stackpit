...
projects-org-filter-label = Фильтр по организации
projects-org-filter-all = Все организации
...
projects-repos-forge-override = Тип форджа
projects-repos-forge-detected = Определяется автоматически
projects-repos-forge-override-help = Задавайте это только если тип определён неверно — обычно для self-hosted-инсталляции, по имени хоста которой нельзя понять, какой фордж на ней работает.
projects-repos-prefix = Префикс пути в стеке
projects-repos-prefix-placeholder = services/api/
projects-repos-prefix-help = Какие кадры стека относятся к этому репозиторию: сравнивается с началом имени файла кадра. Оставьте пустым для проекта с одним репозиторием. Как только у одного из репозиториев здесь появится префикс, работает только сопоставление по префиксу, и репозитории без него перестают давать ссылки на исходники.
projects-repos-col-prefix = Префикс пути
projects-integrations-reset = Вернуть значения организации
projects-integrations-reset-confirm = Отбросить настройки этого проекта и снова доставлять по значениям организации?
projects-integrations-global-hint = Эта интеграция доставляет во все проекты организации. Настройки ниже меняют её только здесь; чтобы полностью прекратить доставку, исключите этот проект на странице интеграции.
projects-integrations-tracker-hint = Репозиторий назначения берётся из настроек репозиториев этого проекта, а не отсюда.
projects-repos-inert = форж неизвестен
projects-repos-inert-help = Stackpit не смог определить, какой форж работает на этом хосте, поэтому репозиторий не даёт ссылок на исходники и не сопоставляется ни с одним трекером задач. Выберите форж ниже и сохраните.
projects-integrations-activate-tracker-heading = Включить трекер задач
projects-integrations-activate-tracker-help = Позволяет этому проекту заводить задачи по требованию. Репозиторий назначения берётся из репозиториев проекта, поэтому больше здесь настраивать нечего.
