...
invite-error-email-mismatch = คำเชิญนี้ออกให้กับอีเมลอื่น โปรดขอคำเชิญที่ไม่จำกัดอีเมล หรือเข้าสู่ระบบด้วยบัญชีที่ตรงกัน
...
orgs-err-license-cap-reached = ถึงขีดจำกัดจำนวนองค์กรของสัญญาอนุญาตแล้ว ลบองค์กรหนึ่งแห่งหรืออัปเกรดสัญญาอนุญาตเพื่อสร้างเพิ่ม
