...
transactions-detail-failure-label = Errori
transactions-list-search-placeholder = Cerca nomi di transazione…
transactions-list-search-label = Cerca nomi di transazione
