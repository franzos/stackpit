...
invite-error-email-mismatch = هذه الدعوة مخصصة لعنوان بريد إلكتروني آخر. اطلب دعوة بدون تقييد البريد الإلكتروني، أو سجّل الدخول بالحساب المطابق.
...
orgs-err-license-cap-reached = تم بلوغ حد المؤسسات في ترخيصك. احذف مؤسسة أو قم بترقية الترخيص لإنشاء مؤسسة أخرى.
