...
projects-repos-forge-override = Forge-Typ
projects-repos-forge-detected = Automatisch erkannt
projects-repos-forge-override-help = Nur setzen, wenn der erkannte Typ falsch ist — meist bei einer selbst gehosteten Instanz, deren Hostname nichts über die verwendete Forge verrät.
projects-repos-prefix = Stack-Pfad-Präfix
projects-repos-prefix-placeholder = services/api/
projects-repos-prefix-help = Welche Stack-Frames zu diesem Repository gehören, verglichen mit dem Anfang des Dateinamens eines Frames. Bei einem Projekt mit nur einem Repository leer lassen. Sobald hier ein Repository ein Präfix hat, gilt nur noch der Präfix-Abgleich, und Repositories ohne Präfix liefern keine Quell-Links mehr.
projects-repos-col-prefix = Pfad-Präfix
...
projects-integrations-reset = Auf Organisationsvorgaben zurücksetzen
projects-integrations-reset-confirm = Die Einstellungen dieses Projekts verwerfen und wieder mit den Vorgaben der Organisation zustellen?
projects-integrations-global-hint = Diese Integration stellt an jedes Projekt der Organisation zu. Die Einstellungen unten passen sie nur hier an; um die Zustellung ganz zu stoppen, schließe dieses Projekt auf der Seite der Integration aus.
...
projects-integrations-tracker-hint = In welches Repository geschrieben wird, ergibt sich aus den Repository-Einstellungen dieses Projekts, nicht von hier.
