...
projects-repos-forge-override = نوع المنصّة
projects-repos-forge-detected = يُكتشف تلقائيًا
projects-repos-forge-override-help = اضبط هذا فقط إذا كان النوع المكتشف خاطئًا — عادةً لخادم ذاتي الاستضافة لا يدل اسم مضيفه على المنصّة التي يشغّلها.
projects-repos-prefix = بادئة مسار المكدّس
projects-repos-prefix-placeholder = services/api/
projects-repos-prefix-help = أي إطارات المكدّس تخصّ هذا المستودع، تُطابَق مع بداية اسم ملف الإطار. اتركه فارغًا في مشروع بمستودع واحد. ما إن تحصل أي مستودع هنا على بادئة، تسري المطابقة بالبادئة وحدها وتتوقف المستودعات بلا بادئة عن إنتاج روابط المصدر.
projects-repos-col-prefix = بادئة المسار
projects-integrations-reset = إعادة الضبط إلى قيم المؤسسة
