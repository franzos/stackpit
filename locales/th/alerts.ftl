...
alerts-notify-types-desc = การแจ้งเตือนปัญหาใหม่และการถดถอยจะทำงานทุกครั้งที่พบปัญหาใหม่หรือปัญหากลับมาอีกครั้ง ควบคุมแยกตามการเชื่อมต่อด้านล่าง กฎค่าขีดเริ่มทำงานตามปริมาณเหตุการณ์ในช่วงเวลาหนึ่ง ส่วนสรุปเป็นภาพรวมตามรอบเวลา
alerts-notify-types-empty = ยังไม่มีการเชื่อมต่อโปรเจกต์ที่ใช้งานอยู่ เชื่อมต่อได้จากหน้าการเชื่อมต่อของโปรเจกต์
