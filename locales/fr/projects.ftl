...
projects-org-filter-label = Filtrer par organisation
projects-org-filter-all = Toutes les organisations
...
projects-repos-forge-override = Type de forge
projects-repos-forge-detected = Détecté automatiquement
projects-repos-forge-override-help = À définir seulement si le type détecté est faux — en général pour une instance auto-hébergée dont le nom d'hôte ne dit rien de la forge qui y tourne.
projects-repos-prefix = Préfixe de chemin
projects-repos-prefix-placeholder = services/api/
projects-repos-prefix-help = Quelles trames de pile appartiennent à ce dépôt, comparées au début du nom de fichier d'une trame. À laisser vide pour un projet à dépôt unique. Dès qu'un dépôt ici a un préfixe, seule la correspondance par préfixe s'applique et les dépôts sans préfixe cessent de produire des liens vers les sources.
projects-repos-col-prefix = Préfixe de chemin
projects-integrations-reset = Rétablir les valeurs de l'organisation
