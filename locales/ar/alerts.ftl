...
alerts-notify-types-desc = تنطلق تنبيهات المشكلات الجديدة والانتكاسات مع كل مشكلة تُرى لأول مرة أو تعود من جديد. تنطلق قواعد الحدّ بناءً على حجم الأحداث خلال نافذة زمنية؛ أمّا الملخّصات فهي تقارير دورية. لا تشمل هذه القائمة إلا التكاملات التي ربطها المشروع بنفسه — أمّا التكامل على مستوى المؤسسة فيصل إلى كل المشاريع ويُدار من صفحة التكاملات.
alerts-notify-types-empty = لم يربط أي مشروع تكاملًا خاصًّا به. لا تظهر التكاملات على مستوى المؤسسة هنا وقد تكون ترسل رغم ذلك؛ راجع صفحة التكاملات.
