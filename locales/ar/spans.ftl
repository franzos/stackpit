...
trace-detail-compressed-note = فجوات الخمول مضغوطة
trace-detail-gap-title = فجوة خمول مطويّة (لا امتدادات نشطة)
trace-detail-lbl-span-id = معرّف الامتداد
trace-detail-lbl-parent = الامتداد الأصل
trace-detail-lbl-status = الحالة
trace-detail-lbl-start = إزاحة البداية
